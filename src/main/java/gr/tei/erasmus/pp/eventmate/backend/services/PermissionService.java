...
public class PermissionService {
    ...
    public Event addPermissionNew(Event event, User user, UserRole userRole) {

        Permission newPermission = new Permission(user.getId(),null,event.getId(),userRole);

        event.getPermissions().add(newPermission);
